...
project = 'fortnite_api'
copyright = '2019-present, Luc1412'
...
resource_links = {
    'issues': 'https://github.com/FortniteAPI/py-wrapper/issues',
    'discussions': 'https://github.com/FortniteAPI/py-wrapper/discussions',
    'examples': f'https://github.com/FortniteAPI/py-wrapper/tree/{branch}/examples',
}
...
htmlhelp_basename = 'fortnite_api.doc'
...
latex_documents = [
    ('index', 'fortnite_api.tex', 'Fortnite API Documentation', 'FortniteAPI', 'manual'),
]
...
man_pages = [('index', 'fortnite_api', 'Fortnite API Documentation', ['FortniteAPI'], 1)]
...
texinfo_documents = [
    (
        ...
        'FortniteAPI',
        'fortnite_api',
        'The Python wrapper for the Fortnite-API.com API.',
        'Python wrapper for Fortnite-API.com API.',
    ),
]
